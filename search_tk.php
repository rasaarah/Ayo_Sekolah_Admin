<?php
 ...
 echo'  <tr >';
                 ...
                 echo'<td  align=""> <a href=" tk_edit.php?id_tk='.$row['id_tk'].' "> <i style="color: black;" class="fa fa-pencil-square-o"></i></a></td>';
                 echo' <td  align=""><a href="tk.php?id_tk='.$row['id_tk'] .'"><i  style="color: black;" class="fa fa-trash-o"></i></a></td>';
               echo' </tr>';
