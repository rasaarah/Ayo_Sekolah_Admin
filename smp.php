...
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> Data SMP</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
              ...
              <br />
               ...
               <?php
                ...
                if(isset($_GET['id_smp'])){
                                    $querydel = mysqli_query($dbc,"DELETE FROM smp WHERE id_smp = '".$_GET['id_smp']."'");
                                    if($querydel){
                                         echo"<script>alert('Daftar SMP ".$_GET['id_smp']." terhapus.'); location='smp.php'</script>";
                                    }
                                }
