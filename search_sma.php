<?php
 ...
 echo'  <tr >';
                 ...
                 echo'<td  align=""> <a href=" sma_edit.php?id_sma='.$row['id_sma'].' "> <i style="color: black;" class="fa fa-pencil-square-o"></i></a></td>';
                 echo' <td  align=""><a href="sma.php?id_sma='.$row['id_sma'] .'"><i  style="color: black;" class="fa fa-trash-o"></i></a></td>';
               echo' </tr>';
