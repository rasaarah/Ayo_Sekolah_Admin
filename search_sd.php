<?php
 ...
 echo'  <tr >';
                 ...
                 echo'<td  align=""> <a href=" sd_edit.php?id_sd='.$row['id_sd'].' "> <i style="color: black;" class="fa fa-pencil-square-o"></i></a></td>';
                 echo' <td  align=""><a href="sd.php?id_sd='.$row['id_sd'] .'"><i  style="color: black;" class="fa fa-trash-o"></i></a></td>';
               echo' </tr>';
