...
/* Koneksi ke Database */
               ...
               if(isset($_POST['submit'])){
                 ...
                 $alamat = $_POST['alamat'];
                  ...
                  if(empty($_POST['kecamatan']) || empty($_POST['nama_sekolah']) || empty($_POST['alamat'])|| $status=="" || empty($_POST['lat'])|| empty($_POST['lng'])|| empty($_POST['c1']) || empty($_POST['c2']) || empty($_POST['c3']))
                              { echo"<script>alert('jangan kosong!'); location='smp_add.php'</script>"; }
                          else
                          {
                            $query=mysql_query("INSERT INTO smp(id_kecamatan,nama,alamat,status,lat,lng,c1,c2,c3)
                              VALUES ('".$nama_kecamatan."','".$nama_sekolah."','".$alamat."','".$status."','".$lat."','".$lng."','".$c1."','".$c2."','".$c3."')");
                              if($query)
                              { echo"<script> alert('DATA BERHASIL DISIMPAN ! ');location='smp.php'</script>";}
                              else
                                { echo"<script> alert('DATA GAGAL DISIMPAN !');location='smp_add.php'</script>";}
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tambah SMA</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
